...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'notetaker_1_0_userprofile', 'first_name')

        # Deleting field 'UserProfile.last_name'
        db.delete_column(u'notetaker_1_0_userprofile', 'last_name')


    def backwards(self, orm):
        # Adding field 'UserProfile.first_name'
        db.add_column(u'notetaker_1_0_userprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 23, 0, 0), max_length=30),
                      keep_default=False)

        # Adding field 'UserProfile.last_name'
        db.add_column(u'notetaker_1_0_userprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 23, 0, 0), max_length=30),
                      keep_default=False)
