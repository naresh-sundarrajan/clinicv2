...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note1'
        db.create_table(u'notetaker_1_0_note1', (
            ...
            ('Provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notetaker_1_0.Provider'])),
        ))
        db.send_create_signal(u'notetaker_1_0', ['Note1'])


    def backwards(self, orm):
        db.send_create_signal(u'notetaker_1_0', ['Note'])

        # Deleting model 'Note1'
        db.delete_table(u'notetaker_1_0_note1')
    ...
    models = {
        ...
        u'notetaker_1_0.note1': {
            'Meta': {'object_name': 'Note1'},
