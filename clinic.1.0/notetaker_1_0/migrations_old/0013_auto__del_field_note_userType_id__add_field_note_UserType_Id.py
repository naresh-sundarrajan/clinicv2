...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.userType_id'
        db.delete_column(u'notetaker_1_0_note', 'userType_id_id')

        # Adding field 'Note.UserType_Id'
        db.add_column(u'notetaker_1_0_note', 'UserType_Id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['notetaker_1_0.UserProfile']),
                      keep_default=False)
    ...
    models = {
        ...
        u'notetaker_1_0.note': {
            ...
            'UserType_Id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notetaker_1_0.UserProfile']"}),
