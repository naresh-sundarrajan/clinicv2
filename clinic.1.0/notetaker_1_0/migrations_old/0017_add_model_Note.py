...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notetaker_1_0_note', (
            ...
            ('Patient_Id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notetaker_1_0.UserProfile'])),
        ))
    ...
    models = {
        ...
        u'notetaker_1_0.note': {
            ...
            'Patient_Id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notetaker_1_0.UserProfile']"}),
